...
const name = 'building-type';                       // 模块名称
const capitalName = firstUpperCase(name);           // 首字母大写驼峰命名
const lowercaseName = firstLowerCase(capitalName);  // 驼峰命名
const allCapitalName = allUpperCase(name);          // 全部大写名称
const pluralityName = pluralize(name);              // 复数
